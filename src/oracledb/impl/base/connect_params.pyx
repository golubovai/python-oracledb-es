...
cdef class ConnectParamsImpl:
    ...
    cdef bytearray _get_obfuscator(self, str secret_value):
        ...
        value.
        """
        return bytearray(secrets.token_bytes(len(secret_value.encode(ENCODING, ENCODING_ERRORS))))
    ...
    cdef str _get_private_key(self):
        ...
        if self._private_key is not None:
            return self._xor_bytes(self._private_key,
                                   self._private_key_obfuscator).decode(ENCODING, ENCODING_ERRORS)
    ...
    cdef str _get_token(self):
        ...
        return self._xor_bytes(self._token, self._token_obfuscator).decode(ENCODING, ENCODING_ERRORS)
    ...
    cdef str _get_wallet_password(self):
        ...
        if self._wallet_password is not None:
            return self._xor_bytes(self._wallet_password,
                                   self._wallet_password_obfuscator).decode(ENCODING, ENCODING_ERRORS)
    ...
    cdef int _set_access_token(self, object val, int error_num) except -1:
        ...
        self._token = self._xor_bytes(bytearray(token.encode(ENCODING, ENCODING_ERRORS)),
                                                self._token_obfuscator)
        if private_key is not None:
            self._private_key_obfuscator = self._get_obfuscator(private_key)
            self._private_key = self._xor_bytes(bytearray(private_key.encode(ENCODING, ENCODING_ERRORS)),
    ...
    cdef int _set_new_password(self, str password) except -1:
        ...
        if password is not None:
            ...
            self._new_password = self._xor_bytes(bytearray(password.encode(ENCODING, ENCODING_ERRORS)),
                                                 self._new_password_obfuscator)
    ...
    cdef int _set_password(self, str password) except -1:
        ...
        if password is not None:
            ...
            self._password = self._xor_bytes(bytearray(password.encode(ENCODING, ENCODING_ERRORS)),
                                             self._password_obfuscator)
    ...
    cdef int _set_wallet_password(self, str password) except -1:
        ...
        if password is not None:
            ...
            self._wallet_password = \
                    self._xor_bytes(bytearray(password.encode(ENCODING, ENCODING_ERRORS)),
                                    self._wallet_password_obfuscator)
